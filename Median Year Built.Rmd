...
#Creating a popup
popup_durham_median_year <- paste0("Census Tract: ",as.character(durham_map_interactive$NAME),"<br/> Median Year of Construction: ",as.character(durham_map_interactive_2$B25035_001E))
